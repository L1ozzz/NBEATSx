...
# Define the Nbeats model using your parameters
nbeats_model = Nbeats(
    input_size_multiplier=30,
    output_size=1,
    ...
    include_var_dict=None,  # Adjust based on your specific setup
...
opt.fit(train_loader)

# Best model
best_model = opt.best_estimator_

best_model.fit(train_ts_loader=train_loader, val_ts_loader=val_loader, eval_steps=100)
